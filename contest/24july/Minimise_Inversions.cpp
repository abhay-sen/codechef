...
ll mergeAndCount(string &arr, ll l, ll m,ll r)
{
    ll n1 = m - l + 1;
    ll n2 = r - m;
    string left;
...
ll mergeSortAndCount(string &arr, ll l, ll r)
{
    ll inv_count = 0;
    if (l < r)
    {
...
ll countInversions(string s)
{
    
    return mergeSortAndCount(s, 0, s.length() - 1);
}
void solve()
{
